...
df = pd.read_csv("https://github.com/RaimbekovA/bank-card-fraud-detection-using-machine-learning/blob/main/CCFD%20v.2/creditcard.csv")
...
if st.sidebar.checkbox('Compare algorithms'):
    ...
    # --- START Training the Random Forest Model on the Training set ---
    st.subheader('Training the Random Forest Model on the Training set')
    ...
    ROC_AUC(y_train, y_train_pred)
    # --- END Training the Random Forest Model on the Training set ---

    # --- START Training the Random Forest Model on the Testing set ---
    st.subheader('Training the Random Forest Model on the Testing set')
    ...
    ROC_AUC(y_test, y_test_pred)
    # --- END Training the Random Forest Model on the Testing set ---
